...
import { login, register } from '../utils/localStorage';
...
export default function AuthPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // For demo purposes, accept any credentials and create a user
    const user = login(loginEmail, loginPassword);
    
    if (!user) {
      // Create a demo user if login fails
      const demoUser = register('Demo User', loginEmail, loginPassword);
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">Welcome to PriceCompare</h1>
          <p className="text-gray-600">Sign in to save favorites and set price alerts</p>
        </div>
        ...
        <Tabs defaultValue="login" className="w-full">
          ...
          <TabsContent value="register">
            <form onSubmit={handleRegister} className="bg-white border border-gray-200 rounded-lg p-6">
              <div className="space-y-4">
                <div>
