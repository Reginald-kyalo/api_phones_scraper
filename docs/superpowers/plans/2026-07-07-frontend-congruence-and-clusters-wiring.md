...
5. **Backend curation**: full catalog with evidence and priorities in [`docs/backend-data-issues.md`](../../backend-data-issues.md) — PR-catalog GBP-as-KES prices (P1), junk homepage deals (P1), NSFW top product (P1), cluster brand/display-name parsing artifacts, missing images/price-history in cluster views, and more.
